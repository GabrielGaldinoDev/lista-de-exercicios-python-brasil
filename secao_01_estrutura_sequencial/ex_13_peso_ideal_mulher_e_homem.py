...
def calcular_peso_ideal():
    ...
    #Calculo e formula
    homem = round((72.7 * altura) - 58, 1)
    mulher = round((62.1 * altura) - 44.7, 1)

    #Exibi o peso
    print(f'Seu peso ideal é {mulher} kg, se você for mulher')
    print(f'Seu peso ideal é {homem} kg, se você for homem')